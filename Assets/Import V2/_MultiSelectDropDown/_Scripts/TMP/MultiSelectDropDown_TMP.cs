...
[AddComponentMenu("UI/MultiSelectDropDown_TMP")]
public class MultiSelectDropDown_TMP : MonoBehaviour
{
    ...
    private ObjectPool<DropDownButton_TMP> m_ItemsPool;
    ...
    private List<DropDownButton_TMP> m_PanelItems;
    ...
    private bool Initialize()
    {
        try
        {
            ...
            m_ItemsPool = new ObjectPool<DropDownButton_TMP>(m_PoolSize, m_Template);
        ...
        m_PanelItems = new List<DropDownButton_TMP>();
